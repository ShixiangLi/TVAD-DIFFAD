...
import torch.nn as nn
from data.dataset_beta_thresh import MVTecTrainDataset,MVTecTestDataset,VisATrainDataset,VisATestDataset,DAGMTrainDataset,DAGMTestDataset,MPDDTestDataset,MPDDTrainDataset,CustomTestDataset,CustomTrainDataset
...
def main():
    ...
    current_classes=custom_dataset_classes
    ...
    for sub_class in current_classes:
        ...
        if sub_class in visa_classes:
            ...
            class_type='DAGM'
        elif sub_class in custom_dataset_classes:
            subclass_path = os.path.join(args["custom_dataset_root_path"],sub_class)
            testing_dataset = CustomTestDataset(
                subclass_path,sub_class,img_size=args["img_size"],
                )
            class_type='Custom'
        ...
        test_loader = DataLoader(testing_dataset, batch_size=1,shuffle=True, num_workers=4)
